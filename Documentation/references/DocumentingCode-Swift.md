NOTE: this document was taken from: [Reactive Cocoa on Github Page](https://github.com/ReactiveCocoa/ReactiveCocoa/blob/master/Documentation/DocumentingCode.md)
